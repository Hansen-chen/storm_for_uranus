...
public class BoltOutputCollectorImpl implements IOutputCollector {
    ...
    public List<Integer> emit(String streamId, Collection<Tuple> anchors, List<Object> tuple) {
        try {
            //return boltEmitOcall(streamId, anchors, (List<Object>)Tools.deep_copy(tuple), null);
            return boltEmitOcall(streamId, anchors, tuple, null);
    ...
    private List<Integer> boltEmitOcall(String streamId, Collection<Tuple> anchors, List<Object> values,
        ...
        for (int i = 0; i < outTasks.size(); ++i) {
            ...
            annotated_emit((AddressedTuple)Tools.deep_copy(new AddressedTuple(t, tupleExt)), (Queue<AddressedTuple>)Tools.deep_copy(executor.getPendingEmits()));

...
public class BoltExecutor extends Executor {
    ...
    @IntelSGX
    public static void annotated_exec(Object rawBoltObject,TupleImpl tuple){
        IBolt boltObject = (IBolt) rawBoltObject;
    ...
    public void tupleActionFn(int taskId, TupleImpl tuple) throws Exception {
        ...
        if (Constants.SYSTEM_FLUSH_STREAM_ID.equals(streamId)) {
            ...
            if(boltObject instanceof Acker || boltObject instanceof MetricsConsumerBolt || boltObject instanceof EventLoggerBolt){
                ...
                annotated_exec(idToTask.get(taskId - idToTaskBase).getTaskObject(), tuple);
            }
